              ...
              <Transition name="fade" mode="out-in">
                ...
                >
                 ...
                 <input
                  ...
                  <input
                    ...
                    placeholder="Agregar Titulo"
                  />
                  <select v-model="card.iduser" placeholder="Miembros" name="asing" id="sign" class="mb-2 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 transition duration-300 ease-in-out focus:border-blue-500 focus:ring-blue-500"> 
                    <option value="1">Christian Ibarra</option>
                    <option value="2">Diego Nieto</option>
                  </select>
                ...
                <div v-else>
                  ...
                  >
                    ...
                    <pre class="mt-1 whitespace-pre-wrap font-sans text-sm" hidden>{{
                      card.content
                    }}</pre>
                  </div>
                </div>
