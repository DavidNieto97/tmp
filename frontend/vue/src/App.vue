...
<template>
  <div v-if="payload" class="flex h-screen flex-col p-4">
    <div class="flex justify-between">
      <div>
        <Transition name="fade" mode="out-in">
          ...
          <div v-else class="flex place-items-center">
            <input
              ...
              placeholder="Agregar Board Titulo"
        ...
        <h3 class="my-2 px-2 text-sm">
          Ultima actualización: {{ payload.last_modified }}
        </h3>
      </div>
    ...
    <div   class="m-1 cursor-pointer rounded-lg bg-white p-2">
<select name="asing" id="sign" class="mb-2 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 transition duration-300 ease-in-out focus:border-blue-500 focus:ring-blue-500"> 
                    <option value="1">Tablero 1</option>
